<?php
    ...
    // check to see if the update button is pressed
    ...
    if( isset( $_POST['delete'] ) ) {
        ...
        $alertMessage = "<div class='alert alert-danger'>
                            ...
                            <form action='". htmlspecialchars( $_SERVER["PHP_SELF"] ) ."?id=$clientID' method='post'>
                                ...
                                <a type='button' class='btn btn-primary btn-sm' data-dismiss='alert'>Oops, no thanks!</a>
                            </form>
                        </div>";
    }
    ...
    if( isset( $_POST['confirm-delete'] ) ) {
        ...
        if( $result ) {
            ...
            echo "Eroor updating record: " .mysqli_error($conn);
        }
